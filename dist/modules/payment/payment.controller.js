...
class PaymentController {
    ...
    createVnpayPayment(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const date = new Date();
                const createDate = (0, moment_timezone_1.default)(date)
                    .tz("Asia/Ho_Chi_Minh")
                    .format("YYYYMMDDHHmmss");
                const expireDate = (0, moment_timezone_1.default)(date)
                    .add(15, "minutes")
                    .tz("Asia/Ho_Chi_Minh")
                    .format("YYYYMMDDHHmmss");
                ...
                const orderId = order_id + (0, moment_timezone_1.default)(date).format("DDHHmmss");
    ...
    refundPayment(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { orderId, transId, amount, description, requestId } = req.body;
                ...
                const result = yield axios_1.default.post("https://test-payment.momo.vn/v2/gateway/api/refund", requestBody, {
                    headers: {
                        "Content-Type": "application/json",
                    },
                });
