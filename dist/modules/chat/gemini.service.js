...
const askGeminiAboutProduct = (prompt, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const answer = (_g = (_f = (_e = (_d = (_c = (_b = (_a = response.data) === null || _a === void 0 ? void 0 : _a.candidates) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.content) === null || _d === void 0 ? void 0 : _d.parts) === null || _e === void 0 ? void 0 : _e[0]) === null || _f === void 0 ? void 0 : _f.text) !== null && _g !== void 0 ? _g : "No response from Gemini";
        return answer;
    }
    catch (error) {
        console.error("Gemini API error:", ((_h = error === null || error === void 0 ? void 0 : error.response) === null || _h === void 0 ? void 0 : _h.data) || error.message);
